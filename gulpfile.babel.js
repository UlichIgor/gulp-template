 ...
 * - FontsWoff2: Обработка шрифтов.
 * - WebpImages: Конвертация изображений в формат WebP.
 * - Resources: Копирование ресурсов.
 * - Styles: Компиляция стилей.
 * - Scripts: Компиляция скриптов.
 * - Sprite: Создание спрайтов.
 * - Html: Обработка HTML файлов.
 * - Browsersync: Запуск локального сервера для разработки.
 * 
 * Задачи для продакшена:
 * - CleanBuild: Очистка временных файлов для продакшена.
 * - FontsWoff2Build: Обработка шрифтов для продакшена.
 * - WebpImagesBuild: Конвертация изображений в формат WebP для продакшена.
 * - ResourcesBuild: Копирование ресурсов для продакшена.
 * - StylesBuild: Компиляция стилей для продакшена.
 * - ScriptsBuild: Компиляция скриптов для продакшена.
 * - SpriteBuild: Создание спрайтов для продакшена.
 * - HtmlBuild: Обработка HTML файлов для продакшена.
 * - BrowsersyncBuild: Запуск локального сервера для продакшена.
 */
